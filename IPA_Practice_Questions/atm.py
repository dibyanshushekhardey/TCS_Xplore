...
class ATM(Account):
    ...
    def updateBalance(self, cardNo, cardPin, withdAmount):
...
for _ in range(n):
    ...
    accountType = input()
    obj_list.append(Account(cardNumber,pin,balance,withdrawalAmount,accountType))
...
ATM_obj = ATM(obj_list)
obj1 = ATM_obj.updateBalance(cardNo,cardPin,withdAmount)
